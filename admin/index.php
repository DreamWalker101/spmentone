...
<head>
  ...
  <title>Admin Login — St Patrick's Primary School</title>
  ...
  <style>
    ...
    .pp-input:focus { border-color: #1F4C23; box-shadow: 0 0 0 2px rgba(31,76,35,0.18); }
    ...
    .pp-btn-secondary:hover { color: #1F4C23; }
    .pp-error {
      display: flex;
      align-items: center;
      gap: 8px;
    ...
    .pp-step-hint strong { color: #1F4C23; font-weight: 600; }
    .pp-page-footer {
      text-align: center;
      margin-top: 28px;
      font-size: 12px;
...
<body class="min-h-screen flex flex-col items-center justify-center p-6">
  ...
  <div class="pp-card">
    <div class="pp-card-header">
      <img src="../assets/images/St-Patricks-Mentone-vertical-lock-up-COLOUR.png"
           alt="St Patrick's Primary School" style="height:52px;width:auto;">
  ...
  <p class="pp-page-footer">St Patrick's Primary School, Mentone</p>
